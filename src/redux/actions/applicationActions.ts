...
export function ensureSecurityToken(
    ...
    return async (dispatch: Dispatch, getState: () => IApplicationState) => {
        ...
        const tokenCountWithTheSamePrefix =
            appState.appSettings.securityTokens.filter((st) =>
                st.name.startsWith(tokenPrefix)
            ).length;
 ...
 */
export interface ISaveAppSettingsAction
    extends IPayloadAction<string, IAppSettings> {
 ...
 */
export interface IEnsureSecurityTokenAction
    extends IPayloadAction<string, IAppSettings> {
 ...
 */
export const saveAppSettingsAction =
    createPayloadAction<ISaveAppSettingsAction>(
...
export const ensureSecurityTokenAction =
    createPayloadAction<IEnsureSecurityTokenAction>(
