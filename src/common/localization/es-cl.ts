...
export const spanish: IAppStrings = {
    ...
    homePage: {
        ...
        prebuiltPredict: {
            ...
            description:
                "Comience con un modelo preconstruidos para extraer datos de sus formularios: facturas, recibos, tarjetas de visita y mucho más. Envíe sus datos y obtenga resultados de inmediato.",
        },
        layoutPredict: {
            title: "Utilice Layout para obtener texto, tablas y marcas de selección",
            description:
                "Pruebe el servicio Diseño del reconocedor de formularios para extraer texto, tablas, marcas de selección y la estructura del documento.",
        },
        trainWithLabels: {
            title: "Utilice Personalizado para entrenar un modelo con etiquetas y obtener pares clave-valor",
            description:
                "Tú proporcionas tus propios datos de entrenamiento y haces el aprendizaje. El modelo que cree puede adaptarse a los formularios específicos de su industria.",
        },
    ...
    appSettings: {
        ...
        securityToken: {
            ...
            duplicateNameErrorMessage:
                "El nombre del token debe ser único para todos los tokens",
        },
        securityTokens: {
        ...
        devTools: {
            description:
                "Abrir herramientas de desarrollo de aplicaciones para ayudar a diagnosticar problemas.",
            button: "Alternar Herramientas de Desarrollo",
        },
        reload: {
            description:
                "Recargar la aplicación descartando todos los cambios actuales",
    ...
    projectSettings: {
        ...
        securityToken: {
            ...
            description:
                "Se utiliza para cifrar datos confidenciales dentro de archivos de proyecto",
        },
        ...
        videoSettings: {
            ...
            description:
                "La velocidad a la que se extraen los marcos para el etiquetado.",
            frameExtractionRate:
                "Tasa de extracción de cuadros (cuadros por segundo de video)",
        },
        addConnection: "Agregar Conexión",
        messages: {
            saveSuccess:
                "Guardado correctamente ${project.name} configuración del proyecto",
            projectExisted:
                "Un proyecto con el nombre ${project.name} ya existe, por favor utilice otro nombre.",
        },
    },
    train: {
        ...
        backEndNotAvailable:
            "La función de casilla de verificación funcionará en la versión futura del servicio de reconocimiento de formularios, manténgase atento.",
        addName: "Agregar nombre de modelo ...",
        downloadJson: "Descargar archivo JSON",
        trainConfirm: {
            title: "Etiquetas aún no revisadas",
            message:
                "Hay archivos recién etiquetados automáticamente aún no revisados por usted, ¿quiere entrenar con esos archivos?",
        },
        errors: {
            electron: {
                cantAccessFiles:
                    "No se puede acceder a los archivos en '${folderUri}' para entrenamiento. Compruebe si el URI de la carpeta especificada es correcto.",
            },
        },
    },
    modelCompose: {
        ...
        limitQuantityComposedModel:
            "Los recursos gratuitos del identificador de formularios soportan hasta cinco modelos en un modelo compuesto.Por favor, actualice a recursos pagados",
        column: {
            icon: {
        ...
        modelView: {
            ...
            NotEnoughModels:
                "Debe tener más de un modelo seleccionado para componer un nuevo modelo",
            modelsCannotBeIncluded:
                "Advertencia: ¡estos modelos no se incluirán en el modelo compuesto!",
            modelCannotBeIncluded:
                "Advertencia: ¡Este modelo no se incluirá en el modelo compuesto!",
            addModelToRecentModels:
                "Modelo [${modelID}] agregado a modelos recientes",
            recentModelsAlreadyContainsModel:
                "Los modelos recientes ya contienen el modelo [${modelID}]",
        ...
        modelsList: {
            ...
            checkAllButtonAria:
                "Botón de verificación Seleccionar todos los modelos",
        },
        errors: {
            failedCompose:
                "¡Algo salió mal, el modelo compuesto no fue creado!",
            noInfoAboutModel:
                "ℹ️  Modelo original no encontrado. No hay información disponible.",
        },
    },
    predict: {
        title: "Analizar",
        ...
        noRecentModels:
            "Este proyecto no tiene modelos recientes. Entrenar o componer un nuevo modelo para analizar.",
        ...
        editAndUploadToTrainingSet:
            "Editar y cargar al conjunto de entrenamiento",
        editAndUploadToTrainingSetNotify:
            "Al hacer clic en este botón, este formulario se agregará al Blob de Azure Storage para este proyecto, donde puede editar estas etiquetas.",
        editAndUploadToTrainingSetNotify2:
            "Estamos agregando este archivo a su conjunto de entrenamiento, donde puede editar las etiquetas y volver a entrenar el modelo.",
        ...
        confirmDuplicatedAssetName: {
            ...
            message:
                "El activo con el nombre '${name}' existe en el proyecto, ¿anularlo?",
        },
    },
    pageRange: {
        title: "Rango de páginas:",
        tooltip:
            "Especifique el número de página o el rango de números de página para procesar, por ejemplo: 1, 5, 7, 9-10",
    },
    prebuiltPredict: {
        ...
        pdfPageNumberLimit:
            "El recurso identificador de formulario de capa libre sólo procesa las primeras 2 páginas del PDF",
    },
    documentFilePicker: {
        source: "Fuente",
    ...
    prebuiltSetting: {
        ...
        serviceEndpointTitle:
            "Dirección del servicio del reconocedor de formularios",
        apiKeyTitle: "Clave API",
        endpointTooltip:
            "Establecer la dirección de la API ej: https://xxx.cognitiveservices.azure.com/",
        endpointPlaceholder: "necesita la dirección de la API",
        apiKeyTooltip:
            "Obtener información clave de la página de claves de recursos y terminales de suscripción de Azure",
    ...
    tags: {
        ...
        warnings: {
            ...
            notCompatibleTagType:
                "El tipo de etiqueta no es compatible con esta función. Si desea cambiar el tipo de esta etiqueta, elimine o reasigne todas las etiquetas que utilizan esta etiqueta en su proyecto.",
            checkboxPerTagLimit:
                "No se puede asignar más de una casilla de verificación por etiqueta",
            notCompatibleWithDrawnRegionTag:
                "Los valores de drawnRegion y ${otherCategory} no pueden asignarse a la misma etiqueta del documento",
            replaceAllExitingLabels:
                "¿Está seguro de que desea reemplazar las etiquetas de la etiqueta seleccionada?",
            replaceAllExitingLabelsTitle:
                "Reemplazar las etiquetas de la etiqueta",
        },
        preText: {
        ...
        regionTableTags: {
            configureTag: {
                errors: {
                    ...
                    checkFields:
                        "Verifique si completó todos los campos obligatorios correctamente.",
                    assignTagName:
                        "El nombre de la etiqueta no puede estar vacío.",
                    notUniqueTagName: "El nombre de la etiqueta debe ser único",
                    emptyTagName:
                        "Asigne un nombre para la etiqueta de su mesa.",
                    emptyName: "El nombre no puede estar vacío",
                    notUniqueName: "El nombre debe ser único",
                    notCompatibleTableColOrRowType:
                        "El tipo $ {kind} no es compatible con este tipo. Si desea cambiar el tipo de este $ {kind}, elimine o asigne todas las etiquetas que usan este $ {kind} en su proyecto.",
                },
            },
            tableLabeling: {
                ...
                description: {
                    ...
                    stepOne:
                        "Seleccione las palabras del documento que desea etiquetar",
                    stepTwo:
                        "Haga clic en la celda de la tabla a la que desea etiquetar las palabras seleccionadas",
                },
                buttons: {
                    done: "Hecho",
            ...
            confirm: {
                reconfigure: {
                    ...
                    message:
                        "¿Está seguro de que desea volver a configurar esta etiqueta?\n Se volverá a configurar para todos los documentos.",
                },
            },
        },
        toolbar: {
            ...
            onlyShowCurrentPageTags:
                "Mostrar solo las etiquetas utilizadas en la página actual",
    ...
    connections: {
        ...
        genericInvalid:
            '"${project.sourceConnection.name}" es una conexión no válida. Por favor verifíquelo en la página Conexiones',
        ...
        messages: {
            ...
            doNotAllowDuplicateNames:
                'La conexión con el nombre "${connection.name}" ya existe. Por favor, use otro nombre',
        },
        imageCorsWarning:
            "Advertencia: Cuando se usa VoTT en un navegador web, es posible que algunos recursos de este \
        ...
        providers: {
            azureBlob: {
                ...
                sas: {
                    title: "SAS",
                    description:
                        "Firma de acceso compartido utilizada para autenticarse en la cuenta de BLOB Storage",
                },
                createContainer: {
                ...
                invalidSASMessage:
                    "Verifique si dispone de permisos de leer/escribir/listar/borrar para el contenedor/blob.",
            },
            bing: {
            ...
            local: {
                ...
                invalidFolderMessage:
                    "La conexión [${project.sourceConnection.providerOptions.folderPath}] y la carpeta del proyecto [${project.folderPath}] no son válidas. Compruebe las carpetas especificadas en las páginas Configuración de conexión y proyecto",
            },
        },
    },
    editorPage: {
        ...
        assetWarning: {
            incorrectFileExtension: {
                ...
                failedToFetch:
                    "No se pudo recuperar ${fileName} para la validación del tipo de mímica",
            },
        },
        ...
        tags: {
            ...
            rename: {
                ...
                confirmation:
                    "¿Está seguro de que quiere cambiar el nombre de esta etiqueta? \
                Será cambiada en todos los recursos",
            },
            delete: {
                title: "Delete Tag",
                confirmation:
                    "¿Está seguro de que quiere borrar esta etiqueta? Será borrada en todos \
        ...
        canvas: {
            ...
            canvasCommandBar: {
                ...
                farItems: {
                    rotate: {
                        clockwise:
                            "Girar la imagen 90 ° en el sentido de las agujas del reloj",
                        counterClockwise:
                            "Girar la imagen 90 ° en sentido antihorario",
                    },
                    zoom: {
                        zoomOut: "Alejar",
                        zoomIn: "Acercar",
                    ...
                    additionalActions: {
                        ...
                        subIMenuItems: {
                            runOcrOnCurrentDocument:
                                "Ejecutar Layout en el documento actual",
                            runOcrOnAllDocuments:
                                "Ejecute Layout en todos los documentos",
                            runAutoLabelingCurrentDocument:
                                "Etiquetar automáticamente el documento actual",
                            runAutoLabelingOnMultipleUnlabeledDocuments:
                                "Etiquetar automáticamente varios documentos sin etiquetar",
                            noPredictModelOnProject:
                                "Predecir modelo no disponible, entrene el modelo primero.",
                            costWarningMessage:
                                "Esta función generará el uso de su cuenta para análisis personalizados.",
                        },
                    },
                },
                warings: {
                    drawRegionUnsupportedAPIVersion:
                        "Las regiones de dibujo no son compatibles con la versión de API ${apiVersion}. Será compatible con el lanzamiento de v2.1",
                },
            },
        },
        messages: {
        ...
        warningMessage: {
            PreventLeavingWhileRunningOCR:
                "Una operación de diseño está actualmente en curso, ¿está seguro de que desea salir?",
            PreventLeavingRunningAutoLabeling:
                "El etiquetado automático está actualmente en curso, ¿está seguro de que desea irse?",
        },
    },
    profile: {
    ...
    shortcuts: {
        ...
        greaterAndLessThan: {
            ...
            description: {
                prevPage:
                    "Ir a la página anterior en documentos de varias páginas",
                nextPage:
                    "Ir a la página siguiente en documentos de varias páginas",
            },
        },
        zoomKeys: {
            keys: {
        ...
        deleteAndBackspace: {
            ...
            description: {
                ...
                backSpace:
                    "Eliminar selección del mapa del documento o clave de selección de una etiqueta",
            },
        },
        drawnRegions: {
            keys: {
            ...
            description: {
                deleteSelectedDrawnRegions:
                    "Eliminar regiones dibujadas seleccionadas",
                cancelDrawOrReshape:
                    "Cancelar la modificación o remodelación de regiones",
            },
        },
        tips: {
            quickLabeling: {
                ...
                description:
                    "Las teclas de acceso rápido de 1 a 0 y todas las letras se asignan a las primeras 36 etiquetas, después de seleccionar una o varias palabras de los elementos de texto resaltados, al presionar estas teclas de acceso rápido, puede etiquetar las palabras seleccionadas.",
            },
            renameTag: {
                name: "Renombrar Etiqueta",
                description:
                    "Mantenga presionada la tecla Alt y haga clic en el nombre de la etiqueta, el usuario puede cambiar el nombre de la etiqueta.",
            },
            multipleWordSelection: {
                name: "Seleccione varias palabras pasando el cursor con el puntero",
                description:
                    "Haga clic y mantenga presionada una palabra. Luego, coloca el cursor sobre palabras adicionales con el puntero.",
            },
            deleteAllLabelsForTag: {
                name: "Eliminar información asociada a una etiqueta",
                description:
                    "Seleccione todas las etiquetas para una etiqueta en el documento y presione la tecla 'delete'",
            },
            groupSelect: {
                name: "Seleccione varias palabras dibujando un cuadro delimitador alrededor de las palabras incluidas",
                description:
                    "Mantenga presionada la tecla Mayús. Luego, haga clic y mantenga presionado el botón izquierdo del ratón. Luego, arrastre el puntero para dibujar el cuadro delimitador alrededor de las palabras incluidas",
            },
        },
        headers: {
    ...
    errors: {
        unknown: {
            ...
            message:
                "La aplicación encontró un error desconocido. Por favor inténtelo de nuevo.",
        },
        projectUploadError: {
        ...
        projectInvalidSecurityToken: {
            ...
            message:
                "Asegúrese de que el token de seguridad del proyecto existe.",
        },
        projectInvalidJson: {
        ...
        projectDeleteErrorSecurityTokenNotFound: {
            ...
            message:
                "Token de seguridad no encontrado. El proyecto [$ {project.name}] se ha eliminado de la herramienta FoTT.",
        },
        projectNotFound: {
            title: "Error en la carga del proyecto",
            message:
                "No podemos encontrar el fichero de proyecto ${file} en el blob container de destino ${container}.\
        ...
        importError: {
            ...
            message:
                "Hubo un error al importar el proyecto V1. Revisa el archivo del proyecto y vuelve a intentarlo",
        },
        pasteRegionTooBigError: {
            title: "Error al pegar region al activo",
            message:
                "Hubo un error al pagar el region al activo. Intenta copiar otra region",
        },
        ...
        blobContainerIONotFound: {
            ...
            message:
                "Compruebe si el contenedor/blob existe en la cuenta de almacenamiento.",
        },
        ...
        projectDeleteForbidden: {
            ...
            message:
                "No puedo eliminar ${file} de su contenedor de blobs del almacenamiento de Azure, debido a la falta de permiso de borrado en el SAS URI.",
        },
        projectDeleteNotFound: {
            title: "Error eliminando proyecto",
            message:
                "No puedo encontrar ${file} en su contenedor de blobs del almacenamiento de Azure. Por favor, verfique si ya ha sido eliminado.",
        },
        predictWithoutTrainForbidden: {
            title: "Error de Predicción",
            message:
                'No podemos encontrar un modelo entrenado. Por favor, vaya a la sección "Train" y verifique que haya un modelo entrenado.',
        },
        missingRequiredFieldInLabelFile: {
            title: "Error cargando fichero de etiquetas",
            message:
                "Visualización de etiquetas desactivada. Verifique que tanto los campos 'documento' como 'etiquetas' existen y no está en blanco en el fichero de etiquetas ${labelFileName}.",
        },
        noLabelInLabelFile: {
            title: "Error cargando fichero de etiquetas",
            message:
                "Visualización de etiquetas desactivada. No hay etiquetas en el fichero de etiquetas ${labelFileName}. Este fichero de etiquetas no puede ser usado para entrenar. Considere añadir etiquetas a este fichero.",
        },
        duplicateFieldKeyInLabelsFile: {
            title: "Error cargando fichero de etiquetas",
            message:
                "Visualización de etiquetas desactivada. Hay nombres de etiquetas duplicados en ${labelFileName}. Por favor, corrija su fichero de etiquetas en el almacenamiento de Azure y verifique que todos los nombres son únicos cuando se eliminen espacios y se conviertan a minúsculas.",
        },
        invalidJSONFormat: {
            title: "Error cargando fichero de etiquetas",
            message:
                "Visualización de etiquetas desactivada. Formato JSON incorrecto en el fichero ${labelFileName}. Por favor, corrija su fichero de etiquetas en el almacenamiento de Azure.",
        },
        sameLabelInDifferentPageError: {
            title: "Error cargando fichero de etiquetas",
            message:
                "Visualización de etiquetas desactivada. La etiqueta ${tagName} se encuentra en más de una página, cada etiqueta debe aplicarse solo en el misma página. Por favor, corrija su fichero de etiquetas en el almacenamiento de Azure.",
        },
        duplicateBoxInLabelFile: {
            title: "Error cargando fichero de etiquetas",
            message:
                "Visualización de etiquetas desactivada. Hay cajas de duplicadas en la página ${page}. Por favor, corrija su fichero de etiquetas en el almacenamiento de Azure.",
        },
        endpointConnectionError: {
            title: "Error en la conexión a la API",
            message:
                "No se puede conectar al API en la dirección ${endpoint}. Por favor, verifique la calidad de su conexión y que la dirección de la API es correcta.",
        },
        tooManyRequests: {
            title: "Demasiadas solicitudes",
            message:
                "Se han realizado demasiadas conexiones en un corto periodo de tiempo. Por favor, inténtelo de nuevo.",
        },
        modelCountLimitExceeded: {
            title: "Demasiados modelos",
            message:
                "El número de modelos asociados con la API indicada, ha superado el límite permitido.",
        },
        requestSendError: {
            title: "solicitud enviar error",
            message:
                "Error al enviar solicitud a Azure Blob Container. Problemas comunes: \n • SAS URI no válida \n • Cross-Origin Resource Sharing (CORS) no está configurado del lado del servidor \n • Error de red",
        },
        modelNotFound: {
            title: "Modelo no encontrado",
            message:
                'Modelo "${modelID}" no encontrado. Por favor use otro modelo.',
        },
        ...
        getOcrError: {
            ...
            message:
                "Error al cargar desde el archivo OCR. Verifique su conexión o configuración de red.",
        },
    },
    shareProject: {
        ...
        errors: {
            cannotDecodeString:
                "No se puede decodificar el token compartido. Compruebe si se ha modificado el token compartido.",
            connectionNotFound:
                "Conexión no encontrada. Agregue la conexión del proyecto compartido a sus conexiones.",
            connectionRequirement:
                "La conexión del proyecto compartido debe agregarse antes de abrirlo",
            tokenNameExist:
                "¡Advertencia! Ya tiene token con el mismo nombre que en el proyecto compartido. Cree un nuevo token y actualice el proyecto existente que usa ''${sharedTokenName}'' con el nuevo nombre del token.",
        },
        copy: {
            success:
                "Token de proyecto copiado al portapapeles y listo para compartir. El receptor del token del proyecto puede hacer clic en 'Abrir proyecto en la nube' desde la página de inicio para usar el token compartido.",
        },
    },
    appSurveyText:
        "Ayúdenos a mejorar Form Recognizer. ¡Responda nuestra encuesta!",
};
