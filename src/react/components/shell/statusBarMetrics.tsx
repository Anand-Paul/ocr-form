...
export class StatusBarMetrics extends React.Component<IStatusBarMetricsProps> {
    public render() {
        ...
        const visitedAssets = projectAssets.filter(
            (asset) =>
