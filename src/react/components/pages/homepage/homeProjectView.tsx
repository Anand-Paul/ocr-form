...
export class HomeProjectView extends React.Component<
    Partial<IHomeProjectViewProps>,
    IHomeProjectViewState
> {
    state = { isOpen: false };
                                ...
                                <ul>
                                    <li>
                                        <a
                                            ...
                                            className="p-5 new-project skipToMainContent"
                                            role="button"
                                        >
                                            <FontIcon
                                                iconName="AddTo"
                            ...
                            {this.props.recentProjects &&
                                this.props.recentProjects.length > 0 && (
                                    <div className="modal-right bg-lighter-1">
                                        <CondensedList
                                            title={
                                                strings.homePage.recentProjects
                                            }
                                            Component={RecentProjectItem}
                                            items={this.props.recentProjects}
                                            onClick={
                                                this.props
                                                    .freshLoadSelectedProject
                                            }
                                            onDelete={(project) =>
                                                this.deleteConfirmRef.current.open(
                                                    project
                                                )
                                            }
                                        />
