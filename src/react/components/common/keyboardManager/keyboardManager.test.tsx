...
describe("Keyboard Manager Component", () => {
    const registrationManagerMock = KeyboardRegistrationManager as jest.Mocked<
        typeof KeyboardRegistrationManager
    >;
    ...
    it("initial state is defined", () => {
        expect(wrapper.state().keyboard).toBeInstanceOf(
    ...
    it("listens for CmdOrCtrl+ keydown events and invokes handlers", () => {
        const keyboardEvent = new KeyboardEvent(KeyEventType.KeyDown, {
            ctrlKey: true,
            key: "1",
        });
        ...
        expect(registrationManagerMock.prototype.invokeHandler).toBeCalledWith(
    ...
    it("listens for CmdOrCtrl+ keyup events and invokes handlers", () => {
        const keyboardEvent = new KeyboardEvent(KeyEventType.KeyUp, {
            ctrlKey: true,
            key: "1",
        });
    ...
    it("listens for CmdOrCtrl+ keypress events and invokes handlers", () => {
        const keyboardEvent = new KeyboardEvent(KeyEventType.KeyPress, {
            ctrlKey: true,
            key: "1",
        });
    ...
    describe("Disabling keyboard manager", () => {
        it("ignores keyboard events when UI is focused on an input element", () => {
            ...
            expect(
                registrationManagerMock.prototype.invokeHandler
            ).not.toBeCalled();
        });
